...
import { MOVIE_GENRES, MOVIE_CERTIFICATION } from '../../constants';
...
const Movies = ({ data }) => {
  ...
  const genres = Object.entries(MOVIE_GENRES);
  const certifications = Object.entries(MOVIE_CERTIFICATION);
